...
function createTemplate(ctx: PageContext): string {
  return `
<!DOCTYPE html>
<html lang="cs">
<head>
...
<body>
  <iframe
    src="https://www.facebook.com/plugins/page.php?href=https://facebook.com/${ctx.page}&tabs=${ctx.tabs}&width=${ctx.width - 16}&height=${ctx.height - 16}&locale=cs_CZ"
    width="${ctx.width}"
    height="${ctx.height}"

...
{
	$ch = createCurl();
	curl_setopt($ch, CURLOPT_URL, "https://jfx-pdf.jfx.cz/post/?displayHeaderFooter=1&marginTop=100&marginBottom=100");
...
{
	$ch = createCurl();
	curl_setopt($ch, CURLOPT_URL, "https://jfx-pdf.jfx.cz/post/");
